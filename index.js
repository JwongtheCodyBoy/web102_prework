...
function filterUnfundedOnly() {
  ...
  let listOfNotMetGames = GAMES_JSON.filter((game) => {
    return game.pledged < game.goal;
  });
  console.log(listOfNotMetGames);

  // use the function we previously created to add the unfunded games to the DOM
  addGamesToPage(listOfNotMetGames);
}
...
newDescriptor.innerText = displayStr;
descriptionContainer.appendChild(newDescriptor);
...
let [firstPlace, secondPlace] = sortedGames;

// create a new element to hold the name of the top pledge game, then append it to the correct element
const firstGameElement = document.createElement("p");
firstGameElement.innerText = firstPlace.name;
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
const secondGameElement = document.createElement("p");
secondGameElement.innerText = secondPlace.name;
